...
CREATE TABLE pois (
  ...
  ai_summary TEXT DEFAULT NULL COMMENT 'AI生成的景点简介（DeepSeek缓存）',
  ai_summary_at DATETIME DEFAULT NULL COMMENT 'AI简介生成时间',
...
CREATE TABLE travel_logs (
  ...
  content_compressed LONGBLOB DEFAULT NULL COMMENT 'Huffman压缩后的游记正文',
  content_encoding VARCHAR(20) DEFAULT NULL COMMENT '正文压缩算法，如 huffman-v1',
  content_original_size INT DEFAULT NULL COMMENT '原始正文UTF-8字节数',
  content_compressed_size INT DEFAULT NULL COMMENT '压缩后二进制字节数',
